# Tests for the Podman rootful scenario
...
variables {
  runner_name         = "test-podman-rootful-runner"
...
run "default_configuration" {
  ...
  assert {
    condition     = module.instance.autoscaling_group_name == "test-podman-rootful-runner-instance-asg"

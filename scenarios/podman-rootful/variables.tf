...
variable "privileged_mode" {
  type        = bool
  description = "Enable Docker privileged mode for runners. Required for container-in-container builds. WARNING: grants near-complete host kernel access to job containers"
  default     = true
}

...
variable "privileged_mode" {
  type        = bool
  description = "Enable Docker privileged mode for runners. Defaults to false for rootless Podman since this scenario is designed for reduced-privilege operation"
  default     = false
}

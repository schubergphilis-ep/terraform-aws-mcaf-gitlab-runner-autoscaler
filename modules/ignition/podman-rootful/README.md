# Ignition Podman Rootful

Ignition configuration for rootful Podman on Fedora CoreOS. Configures root user SSH, Podman socket, and Docker socket compatibility symlink.
...
| Name | Description |
|------|-------------|
| <a name="output_rendered"></a> [rendered](#output\_rendered) | Complete rendered Ignition configuration for rootful Podman |
<!-- END_TF_DOCS -->

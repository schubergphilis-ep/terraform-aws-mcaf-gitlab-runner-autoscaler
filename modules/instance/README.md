...
| <a name="input_kms_key_id"></a> [kms\_key\_id](#input\_kms\_key\_id) | KMS key ID for encrypting EBS volumes. If not provided, uses the AWS managed key (aws/ebs) | `string` | `null` | no |
